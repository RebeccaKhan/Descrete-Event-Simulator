...
main(int argc, char *argv[]) {
    ...
    cmd.AddValue("tcp_variant","TCP Variant name", tcp_variant);
    cmd.AddValue("errorrate", "Error rate of the link",Y);
    cmd.AddValue("delay","Delay of the link", X);
    ...
    pointToPoint.SetChannelAttribute("Delay", StringValue(X));
    ...
    em->SetAttribute("ErrorRate", DoubleValue(Y));
